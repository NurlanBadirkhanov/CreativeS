...
class MyAdsItemFragment : Fragment() {
    private lateinit var binding:FragmentMyAdsItemBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMyAdsItemBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
