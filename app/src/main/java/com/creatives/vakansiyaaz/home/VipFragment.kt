...
import com.creatives.vakansiyaaz.databinding.FragmentVipBinding
...
class VipFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentVipBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun getDataFromFirebase() {
        CoroutineScope(Dispatchers.Main).launch {
            ...
            val reference = database.getReference("Vakancies").child("VakanciesPro")
